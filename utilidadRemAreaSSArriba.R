...
promedioA[vdeltas,has]=mean(sumasArriba)
PromedioJ[vdeltas,has]=mean(junto)
...
#delta=12 meses 
par(lab=c(20,10,10))
plot(inicia,promedio[7,],pch=16,col="red",xlab="Transformadores iniciales",ylab="Transformadores faltantes",main="Utilidad esperada",
