...
inicia=seq(1,23,1) # numero de transformadores al incio de cada periodo
deltas=seq(6,12,1) #periodos de  variacion de las deltas

promedio=matrix(c(rep(0,length(deltas)*length(inicia))),nrow=length(deltas),ncol=length(inicia)) #matriz para guardar los datos obtenidos
...
par(lab=c(20,10,10))
plot(inicia,promedio[1,],pch=19,col="red",xlab="Transformadores iniciales",ylab="Número de meses sin transformadores")
grid()
...
#delta=8
par(lab=c(20,10,10))
plot(inicia,promedio[3,],pch=16,col="red",xlab="Transformadores iniciales",ylab="")
grid()
promedio[3,]
#----------------------------------------------------------------
...
#delta=12 meses 
par(lab=c(20,10,10))
plot(inicia,promedio[7,],pch=16,col="red",xlab="Transformadores iniciales",ylab="Número de meses sin transformadores",main="Utilidad esperada")
grid()
