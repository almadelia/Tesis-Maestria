...
deltas=c(6,8,12) #periodos de  variacion de las deltas
#inicia=10
#deltas=6
peso=0.5
...
{
p=100 #simulaciones de trayectorias
...
par(lab=c(20,10,10))
promedio[1,]
plot(inicia[5:length(inicia)],promedio[1,5:length(inicia)],xlim=c(5,50),xlab="Transformadores iniciales",ylab="", main="Utilidad Esperada", cex.lab=1.5, cex.main=2,pch=19,col="red3",type="b")
lines(inicia,inicia*0.5)
grid()
peso
...
par(lab=c(20,10,10))
plot(inicia,promedio[1,],pch=19,col="red",xlab="Transformadores iniciales",ylab="Meses sin transformadores",type="b", cex.lab=1.5, cex.main=2)
grid()
...
#par(lab=c(20,10,10))
#plot(inicia,mues,pch=19,col="red",xlab="Transformadores iniciales",ylab="Número de meses sin transformadores")
#grid()
#abline(v=13)
#----------------------------------------------------------------
...
#delta=8
par(lab=c(20,10,10))
plot(inicia,promedio[3,],pch=19,col="red",xlab="Transformadores iniciales", main="Utilidad Esperada", cex.lab=1.5, cex.main=2,ylab="Meses sin transformadores",type="b")
grid()
promedio[3,]
#----------------------------------------------------------------
...
#delta=12 meses 
par(lab=c(20,10,10))
plot(inicia,promedio[7,],pch=19,col="red",xlab="Transformadores iniciales",ylab="Meses sin transformadores",
     cex.lab=1.5, cex.main=2,type="b")
grid()
